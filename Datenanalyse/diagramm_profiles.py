...
def create_diagramm():
    data = pd.read_csv(r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources\Version_2\Belieferungsprofile_Diagrammdaten.csv",
    ...
    bar_lot_3.annotate("",
            xy=(0 +0.35, 15), xycoords='data',
            xytext=(1, 10-0.05), textcoords='data',
            arrowprops=dict(arrowstyle="-|>",
                            connectionstyle="angle", lw=2),
            )
    bar_lot_3.annotate("",
            xy=(2 +0.35, 8), xycoords='data',
            xytext=(3, 3-0.05), textcoords='data',
            arrowprops=dict(arrowstyle="-|>",
                            connectionstyle="angle", lw=2),
            )
    bar_lot_3.annotate("",
            xy=(2 +0.35, 21), xycoords='data',
            xytext=(4, 13-0.05), textcoords='data',
            arrowprops=dict(arrowstyle="-|>",
                            connectionstyle="angle", lw=2),
            )
    bar_lot_3.annotate("",
            xy=(5 +0.35, 11), xycoords='data',
    ...
    bar_lot_3.annotate("",
            xy=(7 +0.35, 6), xycoords='data',
            xytext=(9, 2-0.05), textcoords='data',
            arrowprops=dict(arrowstyle="-|>",
                            connectionstyle="angle", lw=2),
            )
    fig.tight_layout()
    ...
    fig.savefig(
        r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources\Version_2\Belieferungsprofile\Versandmengenänderung durch Belieferungsprofile.pdf",
        dpi=2000)
