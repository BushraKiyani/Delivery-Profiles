...
def auswertung_nach_KW(df_touren):
    ...
    df_frequenz.to_csv(
        r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources" + version + r"\Variabiltätsauswertung\frequenz_pro_woche.csv",
        encoding="latin_1", sep=";")
    df_gewicht.to_csv(
        r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources" + version + r"\Variabiltätsauswertung\gewicht_pro_woche.csv",
        encoding="latin_1", sep=";")
...
def variabilitätsauswertung(df_frequenz, df_gewicht):
    ...
    df_auswertung.to_csv(
        r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources" + version + r"\Variabiltätsauswertung\Variablitaetsauswertung.csv",
...
def anteile_nach_varklassen(df):
    ...
    df_borders.to_csv(
        r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources\Version_2\Variabiltätsauswertung\Daten.csv",
        encoding="latin_1", sep=";")
...
def diagramm_3d_barplot(dz):
    ...
    ax1.bar3d(xpos, ypos, zpos, dx, dy, data,
              color=colors)
    fig.tight_layout()
    plt.savefig(r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources\Version_2\Variabiltätsauswertung\Variabilitätsklassen.pdf", dpi=2000)

    #plt.show()

if __name__ == '__main__':
    version = "\Version_2"
    df_touren_all = pd.read_csv(r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources" +version+ "\Datensatz_TK_fertig.csv",
                            encoding="latin_1", sep=";")

    df_ID_list = pd.read_csv(r"C:\Users\Thomas\PycharmProjects\Masterarbeit\Resources" +version+ "\ID_liste.csv",
                            encoding="latin_1", sep=";")
